...
-- Atualizar integração ME existente do tenant MANIA DE MULHER
UPDATE integration_me 
SET 
...
-- Remover dados incorretos do BIQUINI DA TAHY
UPDATE integration_me 
SET 
  from_name = 'BIQUINI DA TAHY LTDA',
  from_email = 'contato@biquinidatahy.com',
  from_phone = '31888888888',
  from_document = '22333444000182',
  from_address = 'Rua das Águas',
  from_number = '456',
  from_complement = 'Loja 1',
  from_district = 'Praia Grande',
  from_city = 'Guarujá',
  from_state = 'SP',
  from_cep = '11470000',
  updated_at = now()
