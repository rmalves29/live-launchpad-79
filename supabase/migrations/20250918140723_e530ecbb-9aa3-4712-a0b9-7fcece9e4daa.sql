...
-- Remover triggers relacionados às integrações removidas se existirem
DROP TRIGGER IF EXISTS sync_company_data_to_integrations ON tenants;
DROP FUNCTION IF EXISTS sync_company_data_to_integrations();
