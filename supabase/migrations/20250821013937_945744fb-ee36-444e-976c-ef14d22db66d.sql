...
-- Add user_id to link customers to auth users (for customer self-service)
...
-- Admins can see all customers, customers can only see their own data
...
-- Updates can only be done by admins or the customer themselves
