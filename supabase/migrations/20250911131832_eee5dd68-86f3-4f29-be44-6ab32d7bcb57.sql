-- Insert default WhatsApp templates for multi-tenant system
...
Digite outros códigos para adicionar mais itens ou responda "finalizar" para concluir seu pedido!'),
  ...
  (NULL, 'ORDER_CREATED', 'Pedido Criado', '🧾 *Pedido #{{order_id}} criado com sucesso!*
...
Em breve enviaremos o link de pagamento.
