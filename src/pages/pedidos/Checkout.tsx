  ...
  const applyCoupon = async (order: Order) => {
    ...
    try {
      ...
      if (coupon) {
        ...
        // Calcular total dos produtos e quantidade de peças
        ...
        // Condição mínima (valor OU quantidade) — não vale para progressivo
      ...
      if (gift) {
        ...
        // Aplicar brinde (não dá desconto monetário, apenas adiciona o brinde)
        setAppliedCoupon({ 
